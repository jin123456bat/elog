						...
						<div class="panel col-md-7 center-block">
							...
							<div class="panel-body">
								...
								<div class="form-group col-md-10">
									...
									<input type="text" class="input_text col-md-3 datetimepicker" name="gettime_start" value="" placeholder="领取开始时间">
									<div class="col-md-1" style="text-align: center; width: 7%;">~</div>
									<input type="text" class="input_text col-md-3 datetimepicker" name="gettime_end" value="" placeholder="领取结束时间">
								...
								<div class="form-group col-md-10">
									...
									<input type="text" class="input_text col-md-7" name="days" value="" placeholder="">
									<span class="col-offset-2 text-helper">从领取时间开始计算，单位天,0永久有效</span>
								</div>
								<div class="form-group col-md-10">
									<label class="label col-md-2">每人领取</label>
									<input type="text" class="input_text col-md-7" name="get_num_per" placeholder="">
									<span class="col-offset-2 text-helper">一个账号最多领取多少张,0代表不限制领取次数</span>
								</div>
								<div class="form-group col-md-10">
									<label class="label col-md-2">累计领取</label>
									<input type="text" class="input_text col-md-7" name="get_num_total" value="" placeholder="">
									<span class="col-offset-2 text-helper">总计可以被领取多少次,0代表不限制领取次数</span>
								</div>
								<div class="form-group col-md-10">
								...
								<div class="form-group col-md-10">
									...
									<div class="input-group col-md-7" style="display: inline-flex;">
										<input type="text" class="input_text col-md-7" name="code" value="" placeholder="系统唯一,不区分大小写，支持中文">
								...
								<div class="form-group col-md-10">
									...
									<textarea name="description" rows="4" class="textarea col-md-7" cols=""></textarea>
