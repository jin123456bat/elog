		...
		<div class="main">
			...
			<div class="body">
				<div class="white-block">
					...
					<div class="col-md-10">
						<form id="room_typeForm" class="form" method="post" action="<?=url('cms/room_type_update')?>">
							<div class="panel col-md-7 center-block">
								...
								<div class="panel-body">
									...
									<div class="form-group col-md-10">
										...
										<input type="text" class="input_text col-md-7" name="name" value="<?=$room_type['name']?>" placeholder="">
									</div>
									<div class="form-group col-md-10">
										<label class="label col-md-2">价格</label>
										<input type="text" class="input_text col-md-7" name="price" value="<?=helper::money_format($room_type['price'])?>" placeholder="">
									</div>
									<div class="form-group col-md-10">
										<label class="label col-md-2">短描述</label>
										<textarea class="textarea col-md-7" rows="5" name="short_desc"><?=$room_type['short_desc']?></textarea>
									</div>
									<div class="form-group col-md-10">
										<label class="label col-md-2">设施</label>
										<input type="text" class="input_text col-md-7" name="tags" value="<?=$room_type['tags']?>" placeholder="">
										<span class="text-helper col-offset-2">多个设施用英文逗号分隔</span>
									</div>
									<div class="form-group col-md-10">
										<label class="label col-md-2">排序</label>
										<input type="text" name="sort" class="input_text col-md-7" value="<?=$room_type['sort']?>">
										<span class="text-helper col-offset-2">从小到大</span>
									</div>
									<div class="form-group col-md-10">
										<label class="label col-md-2">置顶</label>
										<div class="checkbox col-md-7">
											<input type="checkbox" name="top" id="top" <?=$room_type['top']==1?'checked="checked"':''?>>
							...
							<div class="panel col-md-7 center-block">
								...
								<div class="panel-body" id="content"><?=$room_type['content']?></div>
							</div>
...
$(function(){
	...
	$('#image_area').upload({
		<?php if (!empty($room_type['logo_id'])){?>
		init:[{id:<?=$room_type['logo_id']?>,url:'<?=helper::getImageUrl($room_type['logo_path'])?>'}],
		<?php }?>
		width:100,
		height:100,
