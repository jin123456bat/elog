		...
		<div class="main">
			...
			<div class="body">
				<div class="white-block">
					...
					<div class="col-md-10">
						<form id="bannerForm" class="form" method="post" action="<?=url('cms/banner_create')?>">
							<div class="panel col-md-7 center-block">
								...
								<div class="panel-body">
									...
									<div class="form-group col-md-10">
										...
										<input type="text" class="input_text col-md-7" name="description" value="" placeholder="">
									</div>
									<div class="form-group col-md-10">
										<label class="label col-md-2">跳转地址</label>
										<input type="text" class="input_text col-md-7" name="link" value="" placeholder="">
									</div>
									<div class="form-group col-md-10">
