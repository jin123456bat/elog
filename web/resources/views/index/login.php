...
<body>
	...
	<script src="<?=assets::common('jquery.min.js','js')?>"></script>
	<script src="<?=assets::js('Particleground.js')?>"></script>
	<script src="<?=assets::js('jquery.md5.js')?>"></script>
	<script src="<?=assets::common('gt.js','js')?>"></script>
	<script>
	...
	$.ajax({
		...
		url: "<?=url('code')?>?t=" + (new Date()).getTime(), // 加随机数防止缓存
		type: "get",
		dataType: "json",
