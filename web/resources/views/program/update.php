						...
						<div class="panel  center-block">
							...
							<div class="panel-body">
								...
								<div class="form-group col-md-10">
									...
									<input type="text" class="input_text col-md-7" name="url" value="<?=$url?>" readonly>
								</div>
								<div class="form-group col-md-10">
									<label class="label col-md-2">小程序名称</label>
									<input type="text" class="input_text col-md-7" name="name" value="<?=$program['name']?>" placeholder="小程序名称">
								</div>
								<div class="form-group col-md-10">
									<label class="label col-md-2">APPID</label>
									<input type="text" class="input_text col-md-7" name="appid" value="<?=$program['appid']?>" placeholder="小程序名称的APPID">
								</div>
								<div class="form-group col-md-10">
									<label class="label col-md-2">APPSECRET</label>
									<input type="text" class="input_text col-md-7" name="appsecret" value="<?=$program['appsecret']?>" placeholder="小程序名称的appsecret">
								</div>
								<div class="form-group col-md-10">
									<label class="label col-md-2">TOKEN</label>
									<input type="text" class="input_text col-md-7" name="token" value="<?=$program['token']?>" placeholder="令牌TOKEN">
								</div>
								<div class="form-group col-md-10">
									<label class="label col-md-2">EncodingAESKey</label>
									<input type="text" class="input_text col-md-7" name="encoding_key" value="<?=$program['encoding_key']?>" placeholder="EncodingAESKey">
								</div>
								<div class="form-group col-md-10">
									<label class="label col-md-2">消息加解密方式</label>
									<select class="select col-md-7" name="encoding_type">
										<option value="" <?=$program['encoding_type']==0?'selected':''?>>不加密</option>
									</select>
								</div>
								<div class="form-group col-md-10">
									<label class="label col-md-2">数据格式</label>
									<select class="select col-md-7" name="data_type">
										<option value="xml" <?=$program['data_type']=='xml'?'selected':''?>>XML</option>
									</select>
								</div>
							</div>
						</div>
