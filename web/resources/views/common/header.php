<header>
	<div class="nav">
		...
		<div class="center">
			...
			<div class="admin">
				<a href="<?=url('admin/mine')?>"> <img class="image circle" src="<?=!empty($user['gravatar_url']) ? $user['gravatar_url'] : ''?>" onerror="this.src='<?=jin123456bat\assets::common('default_gravatar.png', 'image')?>';">
					<?=$user['username']?>
				</a>
			</div>
		</div>
