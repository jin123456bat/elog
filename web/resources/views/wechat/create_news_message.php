		...
		<div class="main">
			...
			<div class="body">
				<div class="white-block">
					...
					<div class="line"></div>
					<form class="form" id="baseForm" action="<?=url('create_news_message')?>">
						<input type="hidden" name="type" value="news">
						<div class="panel col-md-5 center-block">
							<div class="panel-head">
								<div class="panel-title">添加图文消息</div>
							</div>
											...
											<div>
												<div class="col-md-7 imageArea" data-upload-url='<?=url('common/component/upload')?>'>
													<div class="img-creator-loading">
														...
														<img class="upload-image" name="logo_id" src="<?=assets::common('plus.png','image')?>">
													</div>
												</div>
											</div>
											<div class="res-input">
												<input type="text" class="input_text" name="title" placeholder="添加标题">
											</div>
											<div class="res-input">
												<input type="text" class="input_text" name="jump_url" placeholder="添加跳转链接">
											</div>
											<div class="res-input">
	...
	$(function(){
		...
		$('#baseForm').validate({
			...
			submitHandler : function(form) {
				...
				var res = true;
				$('.res-form').each(function (index,element) {
					var send_data={};
