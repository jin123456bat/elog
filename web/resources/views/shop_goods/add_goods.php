			...
			<div class="body">
				<div class="white-block">
                  ...
                  <?php
																		...
																		function getSon($id, $array = array(), $level = 0)
																		{
																			$str = '';
																			static $lists;
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-inline">
								<input type="number" name="weight" lay-verify="weight" autocomplete="off" placeholder="请输商品重量" class="layui-input">
							</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-inline">
								<textarea name="short_desc" placeholder="请输入内容" maxlength="1024" class="layui-textarea"></textarea>
							</div>
						</div>
						<div class="layui-form-item">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								...
								<div class="layui-form-mid layui-word-aux">
									每张图片大小不能超过1M,格式只能是'png,jpg,jpeg,gif',
						...
						<div class="layui-form-item">
							<div class="layui-block">
								...
								<div class="layui-input-inline">
									<input type="text" class="layui-input" name="start_time" id="start_time" value="<?=date('Y-m-d H:i:s')?>">
								</div>
							</div>
						</div>
						<div class="layui-form-item">
							<div class="layui-block">
								...
								<div class="layui-form-mid layui-word-aux">空为不自动下架</div>
							</div>
						</div>
						<!-- 属性填写框 -->
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								...
								<input type="radio" name="status" value="0" title="不上架">
							</div>
						</div>
						<div class="layui-form-item">
							<label class="layui-form-label">自动发货</label>
							<div class="layui-input-block">
								<input type="radio" name="auto_ship" value="1" checked="" title="自动">
								<input type="radio" name="auto_ship" value="0" title="不自动">
							</div>
						</div>
						<div class="layui-form-item">
							<label class="layui-form-label">特惠中心</label>
							<div class="layui-input-block">
								<input type="radio" name="special_center" value="1" title="是">
								<input type="radio" name="special_center" value="0" checked title="否">
							</div>
							<div class="layui-form-mid layui-word-aux">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-inline">
								<input type="number" min="0" name="sort" lay-verify="sort" value="0" autocomplete="off" placeholder="数值越小越靠前" class="layui-input">
							</div>
						...
						<div id="property_input"></div>
						<input type="hidden" name="logo_main" value="">
						<input type="hidden" name="logo_id" value="" lay-verify="logo_id">
...
function addProperty(ev) {
    ...
    if (name) {
        ...
        $.each(arr, function(k, v) {
            ...
            str += '<div class="layui-form-mid layui-word-aux" style="width:700px;"><span>' + specification + '(价格、库存、每日库存、积分、sku编码、最大购买数量：0不限制、是否需要填写地址：0为不需要)</span></div>';
            ...
            str += '<div class="layui-input-inline floatNone"><div class="layui-form-mid layui-word-aux">&emsp;</div><input type="text" name="max_num||' + specification + '" autocomplete="off" class="layui-input" value="0" placeholder="最大购买数量"></div>';
...
layui.use('form', function() {
    ...
    form.on('submit(addGoods)', function(data) {
      ...
      $.each(data.field,function(k,v){
        ...
        //处理库存
        if(k.indexOf('stock')==0){
          var arr = k.split('||');
          var key = arr[1];
          stock[key] = v;
        }
        //处理每日库存
        if(k.indexOf('stock_per_dau') == 0)
        {
        	var arr = k.split('||');
            var key = arr[1];
            stock_per_dau[key] = v;
