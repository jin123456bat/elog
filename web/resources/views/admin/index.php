		...
		<div class="main">
			...
			<div class="body">
				<div class="white-block">
					...
					<div class="line">
						<?php if (companyController::checkButtonPrivilege('create_admin')){?>
...
var table = datatables({
	...
	columns:[{
		...
		render:function(data,full){
			content = '';
			<?php if (companyController::checkButtonPrivilege('update_admin')){?>
			content += '<a class="button button-xs edit" title="update_admin" data-id="'+full.id+'">查看/编辑</a>';
			<?php }?>
			<?php if (companyController::checkButtonPrivilege('delete_admin')){?>
